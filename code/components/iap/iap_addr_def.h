...
//芯片flash大小
#define BR_PAGE_SIZE                      (0x1000)      /* 4 Kbytes */
#define BR_FLASH_SIZE                     (0x20000)     /* 512：0x80000，256：0x40000 KBytes */
...
#define BINPAGE_SIZE                    (96*1024/BR_PAGE_SIZE)     //升级文件所需页数

#define BOOTLOAD_FIRMWARE_SIZE          (32 * 1024)
#define BOOTLOAD_FIRMWARE_ADDR          BR_FLASH_BASE
#define FACTORY_FIRMWARE_SIZE           (96 * 1024)
#define FACTORY_FIRMWARE_ADDR           (BOOTLOAD_FIRMWARE_ADDR + BOOTLOAD_FIRMWARE_SIZE)
#define APPLICATION_FIRMWARE_SIZE       (96 * 1024)
#define APPLICATION_FIRMWARE_ADDR       (BOOTLOAD_FIRMWARE_ADDR + BOOTLOAD_FIRMWARE_SIZE)
#define DOWNLOAD_AREA_SIZE              (96 * 1024)
...
#define USER_DATA_SIZE                  (408 * 1024)
#define USER_DATA_ADDR                  (DCD_DATA_ADDR + DCD_DATA_SIZE)                     	//USER区待用

#else

#define BINPAGE_SIZE                    (56*1024/BR_PAGE_SIZE)     //升级文件所需页数

#define BOOTLOAD_FIRMWARE_SIZE          (10 * 1024)
#define BOOTLOAD_FIRMWARE_ADDR          BR_FLASH_BASE
#define FACTORY_FIRMWARE_SIZE           (56 * 1024)
#define FACTORY_FIRMWARE_ADDR           (BOOTLOAD_FIRMWARE_ADDR + BOOTLOAD_FIRMWARE_SIZE)
#define APPLICATION_FIRMWARE_SIZE       (56 * 1024)
#define APPLICATION_FIRMWARE_ADDR       (BOOTLOAD_FIRMWARE_ADDR + BOOTLOAD_FIRMWARE_SIZE)
#define DOWNLOAD_AREA_SIZE              (56 * 1024)
...
#define APP1adress                      FACTORY_FIRMWARE_ADDR           //0x08002800,240K,第一个应用程序起始地址(存放在FLASH)
#define APPUPadress                     APPLICATION_FIRMWARE_ADDR       //0x08002800,240K,需要更新区
#define APPTEMPadress                   DOWNLOAD_AREA_ADDR              //0x0803E800,240K,更新数据暂存的地址
#define UPGRADEaddr                     UPGRADE_DATA_ADDR               //0x0807a800,2K,固件更新标识要写入的FLASH的首地址
#define DCDadress                       DCD_DATA_ADDR                   //0x0807b000,2K,电源引脚数据存储区
#define USERadress                      USER_DATA_ADDR                  //0x0807b800,18K,日志区
...
#define DCD_DATA_SIZE                   (4 * 1024)
#define DCD_DATA_ADDR                   (UPGRADE_DATA_ADDR + UPGRADE_DATA_SIZE)                 //电源引脚存储区
#define USER_DATA_SIZE                  (536 * 1024)
#define USER_DATA_ADDR                  (DCD_DATA_ADDR + DCD_DATA_SIZE)                     	//USER区待用
#else
#define BINPAGE_SIZE                    (220*1024/BR_PAGE_SIZE)     //升级文件所需页数

#define BOOTLOAD_FIRMWARE_SIZE          (16 * 1024)	
#define BOOTLOAD_FIRMWARE_ADDR          BR_FLASH_BASE
#define FACTORY_FIRMWARE_SIZE           (220 * 1024)
#define FACTORY_FIRMWARE_ADDR           (BOOTLOAD_FIRMWARE_ADDR + BOOTLOAD_FIRMWARE_SIZE)
#define APPLICATION_FIRMWARE_SIZE       (220 * 1024)
#define APPLICATION_FIRMWARE_ADDR       (BOOTLOAD_FIRMWARE_ADDR + BOOTLOAD_FIRMWARE_SIZE)
#define DOWNLOAD_AREA_SIZE              (220 * 1024)
#define DOWNLOAD_AREA_ADDR              (APPLICATION_FIRMWARE_ADDR + APPLICATION_FIRMWARE_SIZE)
#define UPGRADE_DATA_SIZE               (4 * 1024)
#define UPGRADE_DATA_ADDR               (DOWNLOAD_AREA_ADDR + DOWNLOAD_AREA_SIZE)
#define DCD_DATA_SIZE                   (4 * 1024)
#define DCD_DATA_ADDR                   (UPGRADE_DATA_ADDR + UPGRADE_DATA_SIZE)                 //电源引脚存储区
#define USER_DATA_SIZE                  (48 * 1024)
...
#define UPGRADEaddr                     UPGRADE_DATA_ADDR               //0x0807a800,2K,固件更新标识要写入的FLASH的首地址
#define DCDadress                       DCD_DATA_ADDR                   //0x0807b000,2K,电源引脚数据存储区
#define USERadress                      USER_DATA_SIZE                  //0x0807b800,18K,日志区
...
#define DCD_DATA_SIZE                   (4 * 1024)
#define DCD_DATA_ADDR                   (UPGRADE_DATA_ADDR + UPGRADE_DATA_SIZE)             //电源引脚存储区
#define USER_DATA_SIZE                  (792 * 1024)
#define USER_DATA_ADDR                  (DCD_DATA_ADDR + DCD_DATA_SIZE)                     //USER区待用
#else
