...
#define		LOG_FILE		   __FILE__			/**< 所在文件路径 */
#define		LOG_LINE		   __LINE__			/**< 所在文件行数 */
#define		LOG_LOCAL_TIME	   sys_hour_get(),sys_minute_get(),sys_second_get(),sys_msecond_get()	
...
#define     ERROR_TEXT          CSI(31) "E [%02d:%02d:%02d,%03d] (%s) %s [%d]:" CSI(39)     /**< 错误标签 */
#define     WARNING_TEXT        CSI(33) "W [%02d:%02d:%02d,%03d] (%s) %s [%d]:" CSI(39)     /**< 警告标签 */
#define     INFO_TEXT           CSI(94) "I [%02d:%02d:%02d,%03d] (%s) %s [%d]:" CSI(39)     /**< 信息标签 */
#define     DEBUG_TEXT          CSI(32) "D [%02d:%02d:%02d,%03d] (%s) %s [%d]:" CSI(39)     /**< 调试标签 */
#define     VERBOSE_TEXT        CSI(36) "V [%02d:%02d:%02d,%03d] (%s) %s [%d]:" CSI(39)     /**< 冗余信息标签 */
#else
#define     ERROR_TEXT          "E [%02d:%02d:%02d,%03d] (%s) %s:"
#define     WARNING_TEXT        "W [%02d:%02d:%02d,%03d] (%s) %s:"
#define     INFO_TEXT           "I [%02d:%02d:%02d,%03d] (%s) %s:"
#define     DEBUG_TEXT          "D [%02d:%02d:%02d,%03d] (%s) %s:"
#define     VERBOSE_TEXT        "V [%02d:%02d:%02d,%03d] (%s) %s:"
#endif
...
#define logFormat(text, level, fmt, ...) \
            ...
            logWrite(LOG_ALL_OBJ, level, text " " fmt "" LOG_END, \
                LOG_LOCAL_TIME,LOG_FILE,LOG_TAG,LOG_LINE, ##__VA_ARGS__); }		 	  \
